...
INSERT INTO varsel_tittel(varselkode_ref, tittel) VALUES
    ...
    ((SELECT id FROM varselkode WHERE kode = 'RV_AY_1'), 'Arena inneholdt en eller flere AAP-perioder med ugyldig fom/tom'),
    ((SELECT id FROM varselkode WHERE kode = 'RV_AY_2'), 'Arena inneholdt en eller flere Dagpengeperioder med ugyldig fom/tom'),
...
INSERT INTO varsel_forklaring(varselkode_ref, forklaring) VALUES
    ...
    ((SELECT id FROM varselkode WHERE kode = 'RV_AY_1'), 'Det foreligger AAP-perioder med ugyldig fom/tom'),
    ((SELECT id FROM varselkode WHERE kode = 'RV_AY_2'), 'Det foreligger Dagpengeperioder med ugyldig fom/tom'),
...
INSERT INTO varsel_handling(varselkode_ref, handling) VALUES
    ...
    ((SELECT id FROM varselkode WHERE kode = 'RV_AY_1'), 'Kontrollér ny opptjeningstid etter maksdato'),
    ((SELECT id FROM varselkode WHERE kode = 'RV_AY_2'), 'Sjekk om bruker er dagpengemottaker på sykmeldingstidspunktet. Hvis ja kan ikke saken behandles i dette systemet ennå.'),
